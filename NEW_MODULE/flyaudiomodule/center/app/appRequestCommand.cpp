...
void SetAlarmTip(unsigned char *tip, u8 len)
{
	u8 param[] = {0x12, 0x00, 0x00};
	param[1] = tip[0];
	param[2] = tip[1];
...
void setAlarmRingerCtrl(unsigned char ring){
	u8 param[] = {0xF1, 0x00};
	param[1] = ring;
	setCommand(0x00000000, param, 2);
}
...
void setSyncContectStateToUI(u8 param)
{
	u8 buff[]={0x3d,0x01,param};
	setCommand(0x00000000, buff, 3);
}