...
void  initTimerCenter(timer_handler_function func){
    ...
    makeAndSendMessageToModule(MODULE_ID_EXTCAR_HONDA_TSU,MODULE_ID_TIMER,buf,5);
...
int SetTimer(int nElaspe_ms, int nMode, int timerId){
    ...
    makeAndSendMessageToModule(MODULE_ID_EXTCAR_HONDA_TSU,MODULE_ID_TIMER,buf,10);
