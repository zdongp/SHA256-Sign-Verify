...
LOCAL_SRC_FILES += myBaseClass/CarInfo.cpp \
				   toyotaPrado/CarInfoToyotaPrado.cpp \
				   toyotaCarSetting/CarSettingToyota.cpp
...
LOCAL_EXTCAR_MODULE_INCLUDES :=	$(FLYMODULE_INCLUDE) \
										$(FLY_AUDIO_INCLUDE) \
										$(LOCAL_PATH) \
										$(FLY_INCLUDE) \
...
LOCAL_INCLUDES := $(LOCAL_EXTCAR_MODULE_INCLUDES)
LOCAL_C_INCLUDES := $(LOCAL_EXTCAR_MODULE_INCLUDES)
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/define \
					...
					$(LOCAL_PATH)/timer \
					$(LOCAL_PATH)/myBaseClass \
					$(LOCAL_PATH)/toyotaPrado \
					$(LOCAL_PATH)/toyotaCarSetting\
					$(LOCAL_PATH)/flyJniSdk \
					$(NDK_ROOT)/sources/cxx-stl/stlport/stlport

LOCAL_LDLIBS:= -llog

#LOCAL_LDFLAGS += -L$(NDK_ROOT)/sources/cxx-stl/stlport/libs/arm64-v8a/ -lstlport_static
