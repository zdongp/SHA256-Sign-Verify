...
LOCAL_BT_MODULE_INCLUDES :=	$(FLY_AUDIO_INCLUDE) \
...
LOCAL_INCLUDES := $(LOCAL_BT_MODULE_INCLUDES)
LOCAL_C_INCLUDES += $(LOCAL_BT_MODULE_INCLUDES)
LOCAL_CFLAGS := -D_STLP_USE_NO_IOSTREAMS -D_STLP_USE_MALLOC
#LOCAL_CFLAGS := -D_STLP_USE_NEWALLOC

LOCAL_SRC_FILES :=api.cpp\
					btAdapter/BtAdapter.cpp\
					FlyBt/BtParam.cpp\
					FlyBt/BtApp.cpp \
					FlyBt/BtModule.cpp \
					FlyBt/BtHal.cpp \
					FlyBt/BtJniSdk.cpp \
					pages/BtMainPage.cpp\
					pages/BtDevicePages.cpp\
					pages/PhoneBookPages.cpp\
					pages/CallRecordPages.cpp\
					pages/A2DPpages.cpp\
					pages/MusicBrowsingPage.cpp\
					pages/BtConnectionSetPages.cpp\
					#FlyBt/PhoneBook.cpp
...
LOCAL_MODULE :=  mt3561_bt.flyaudio
