...
LOCAL_FATMODULE_INCLUDES :=$(FLYMODULE_INCLUDE) \
										$(FLY_AUDIO_INCLUDE) \
										$(LOCAL_PATH) \
										$(FLY_INCLUDE) \
										...
										$(LOCAL_PATH)/FlyAutomate \
										$(NDK_ROOT)/sources/cxx-stl/stlport/stlport \
										
LOCAL_INCLUDES := $(LOCAL_FATMODULE_INCLUDES)
LOCAL_C_INCLUDES := $(LOCAL_FATMODULE_INCLUDES)
LOCAL_CFLAGS := -D_STLP_USE_NO_IOSTREAMS -D_STLP_USE_MALLOC
#LOCAL_CFLAGS := -D_STLP_USE_NEWALLOC

LOCAL_SRC_FILES :=api.cpp\
					FlyAutomate/fly_log.cpp \
					FlyAutomate/FatParam.cpp \
					FlyAutomate/FatApp.cpp \
					FlyAutomate/FatModule.cpp \
					FlyAutomate/FatHal.cpp \
					FlyAutomate/FatAudioVedio.cpp \
					FlyAutomate/FatAUX.cpp \
					FlyAutomate/FatDVD.cpp \
					FlyAutomate/FatDVR.cpp \
					FlyAutomate/FatMedia.cpp \
					FlyAutomate/FatRadio.cpp \
					FlyAutomate/FatSystem.cpp \
					FlyAutomate/FatTPMS.cpp \
					FlyAutomate/FatBlueTooth.cpp \
					FlyAutomate/FatiPod.cpp \
					FlyAutomate/flyi2c.c \
					FlyAutomate/CP.cpp \
...
LOCAL_MODULE := automate.flyaudio
