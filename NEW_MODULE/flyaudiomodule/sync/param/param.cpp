...
sync_local_param_t localParam;
sync_local_param_t *pLocalParam = (sync_local_param_t*)&localParam;

sync_global_param_t globalParam;
sync_global_param_t *pGlobalParam = (sync_global_param_t*)&globalParam;
