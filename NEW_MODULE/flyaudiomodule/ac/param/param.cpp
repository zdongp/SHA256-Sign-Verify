...
//air_global_param_t globalParam;
//air_global_param_t *pGlobalParam = (air_global_param_t*)&globalParam;

CAcJniSdk g_pClsAcJniSdk;
...
{
	return (uni16_size_t)strlen((char*)uni16);
}
