...
void set_airconditionFlash(u16 pageindex, u16 falshID){

}
//int inPage_AC(u16 pageID){
	//return pageID==PAGE_AIRCONDITION ? false : true;
//	if(pageID == PAGE_AIRCONDITION)
//		return false;
//	else
//		return true;
//}
void setup_ShowAC(u8 bParam){
	if (bParam == 1)
		setDigitalData(CONTROLID_MENU_AIRCONDITION ,true);
	else
		setDigitalData(CONTROLID_MENU_AIRCONDITION ,false);
}
